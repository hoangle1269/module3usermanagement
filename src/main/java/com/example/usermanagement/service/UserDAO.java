...
public class UserDAO implements IUser {
    ...
    private static final String SELECT_ALL_USERS_SORTED_BY_NAME = "SELECT * FROM users ORDER BY name";
    ...
    public List<User> selectAllUsers() {
        ...
        try (Connection connection = getConnection();
            ...
            System.out.println(preparedStatement);
            selectUser(users, preparedStatement);
        } catch (SQLException e) {
            printSQLException(e);
        }
        return users;
    ...
    private void selectUser(List<User> users, PreparedStatement preparedStatement) throws SQLException {
