...
import com.example.usermanagement.service.UserDAO;
...
public class UserServlet extends HttpServlet {
        ...
        try {
            switch (action) {
                ...
                case "search":
                    ...
                    break;
                case "sort":
                    listUsersSortedByName(request, response);
                    break;                default:
    ...
    private void listUsersSortedByName(HttpServletRequest request, HttpServletResponse response)
            throws SQLException, IOException, ServletException {
        List<User> users = userDAO.selectAllUsersSortedByName();
        request.setAttribute("listUser", users);
        RequestDispatcher dispatcher = request.getRequestDispatcher("user/list.jsp");
        dispatcher.forward(request, response);
    }
